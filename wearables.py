...
import math
import pandas as pd
rf = joblib.load("models/PM.pkl")  #Cargamos el QDA
...
st.markdown(
	...
	<img src = 'https://viis.udenar.edu.co/wp-content/uploads/2019/07/Maestria-ingenieria-electronica-291x200.jpg'style = 'width : 13%;'>
	<img src = 'https://saturdays.ai/wp-content/uploads/2021/01/logo.png' style = 'width : 20%;'height : 10vh; position : absolute; right : 0; top : 8vh; margin : 0'>
	''', 
